...
public class Fragment_Tab_Donasi_Dana_Panti extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_donasi_dana_panti,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Donasi_Dana_Panti(), "Disetujui");
        adapter.addFragment(new Fragment_Donasi_Dana_Menunggu_Panti(), "Menunggu Konfirmasi");
