...
public class Fragment_Tab_Donatur_Tetap_Panti extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_donatur_tetap_panti,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Donatur_Tetap_Panti(), "Diterima");
        adapter.addFragment(new Fragment_Donatur_Tetap_Menunggu_Panti(), "Menunggu Konfirmasi");
