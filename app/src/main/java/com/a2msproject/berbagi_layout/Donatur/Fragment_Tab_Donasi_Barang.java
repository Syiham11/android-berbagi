...
public class Fragment_Tab_Donasi_Barang extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_donasi_barang,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Donasi_Barang(), "Disetujui");
        adapter.addFragment(new Fragment_Donasi_Barang_Menunggu(), "Menunggu Konfirmasi");
