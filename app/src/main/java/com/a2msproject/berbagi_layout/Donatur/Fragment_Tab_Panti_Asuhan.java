...
public class Fragment_Tab_Panti_Asuhan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_panti_asuhan,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Panti_Asuhan(), "Panti Asuhan");
        adapter.addFragment(new Fragment_Panti_Asuhan(), "Rekomendasi");
