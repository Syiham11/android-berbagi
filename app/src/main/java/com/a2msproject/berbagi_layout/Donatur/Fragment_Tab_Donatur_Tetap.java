...
public class Fragment_Tab_Donatur_Tetap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_donatur_tetap,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Donatur_Tetap(), "Diterima");
        adapter.addFragment(new Fragment_Donatur_Tetap_Menunggu(), "Menunggu Konfirmasi");
