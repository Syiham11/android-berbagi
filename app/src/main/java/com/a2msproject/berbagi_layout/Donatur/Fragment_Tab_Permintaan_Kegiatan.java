...
public class Fragment_Tab_Permintaan_Kegiatan extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dataView = inflater.inflate(R.layout.fragmant_tab_permintaan_kegiatan,
                container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Fragment_Permintaan_Kegiatan(), "Disetujui");
        adapter.addFragment(new Fragment_Permintaan_Kegiatan_Menunggu(), "Menunggu Konfirmasi");
